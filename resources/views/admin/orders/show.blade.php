    ...
    <div class="max-w-sm mx-auto">
        ...
        <div class="bg-white rounded-none shadow-md">
            ...
            <div class="bg-white p-8 text-center">
                ...
                <div class="w-24 h-24 mx-auto mb-4 rounded-full border-[6px] border-green-800 flex items-center justify-center">
                    <div class="w-10 h-10 rounded-full bg-green-800"></div>
                </div>
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-md">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-700 mt-1">Pesanan Anda telah selesai! Terima kasih telah memesan.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 pt-0">
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <button onclick="window.print()"
                            class="flex items-center justify-center px-4 py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-lg shadow transition-colors text-sm">
