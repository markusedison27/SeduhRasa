    ...
    <div class="w-full flex justify-center mt-10 lg:mt-16">
        <div class="w-full max-w-sm relative">
            ...
            <div
                ...
                {{-- ===== FLASH MESSAGE DARI SESSION (GOOGLE, LOGOUT, RESET PASSWORD) ===== --}}
                @php
                ...
                @if (session('error'))
                    <div
                        class="mb-5 rounded-xl ring-1 px-4 py-3.5 text-sm flex items-start gap-3 card-animate shake bg-red-50 text-red-800 ring-red-200/70">
                        <svg class="w-5 h-5 flex-shrink-0 mt-0.5 pulse-icon" fill="currentColor"
                            viewBox="0 0 20 20">
                ...
                @if ($successMessage)
                    <div
                        class="mb-5 rounded-xl ring-1 px-4 py-3.5 text-sm flex items-start gap-3 card-animate bg-emerald-50 text-emerald-800 ring-emerald-200/70">
                ...
                {{-- ===== ERROR MESSAGE DINAMIS (LOGIN ATTEMPT + LOCK) ===== --}}
                @if ($errors->any())
                    @php
