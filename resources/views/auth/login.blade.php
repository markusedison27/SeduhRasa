...
@section('content')
    <div class="w-full max-w-sm">
        ...
        <div
            class="bg-white/85 backdrop-blur rounded-xl ring-1 ring-stone-200 shadow-[0_10px_30px_-12px_rgba(0,0,0,.25)] p-6">
                ...
                <div class="flex items-center justify-between">
                    <label class="inline-flex items-center gap-2 text-sm">
                        <input type="checkbox" name="remember"
                            class="rounded border-stone-300 text-[#7B3F00] focus:ring-[#C67C4E]">
                        Ingat saya
                    </label>
