        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-700 lg:grow">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                    ...
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li
                            ...
                            <span class="relative py-1 bg-white dark:bg-[#161615]"> <span
                                    ...
                                    class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[color:var(--tw)] text-[#f53003] dark:text-[#FF4433] ml-1">
                ...
                <div
                    ...
                    {{-- Laravel Logo --}} <svg
                        class="w-full text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-100 max-w-none duration-700"
