...
<head>
  ...
  {{-- Tailwind font-family override --}}
  <style>
    .font-great-vibes { font-family: 'Great Vibes', cursive; }
    .font-poppins { font-family: 'Poppins', sans-serif; }
  </style>
</head>
<body class="bg-[#f6efe7] text-stone-800 font-poppins">
  ...
  <section class="relative h-[50vh] md:h-[60vh] overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
      <h1 class="font-great-vibes text-5xl md:text-6xl mb-2 text-amber-400">Tentang Kami</h1>
  ...
  <section class="max-w-7xl mx-auto px-6 py-16">
    <div class="text-center mb-12">
      <h2 class="font-great-vibes text-4xl md:text-5xl text-amber-700">Tim Kami</h2>
      <p class="text-stone-600 mt-3">Berkenalan dengan kami, para pencinta kopi di balik SeduhRasa ☕</p>
    </div>

    @php
      $team = [
        ['name'=>'M. Arifin Ilham', 'img'=>'welcome(1).jpg'],
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
      @foreach ($team as $person)
        <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:-translate-y-2 transition-all duration-300">
          <div class="bg-gradient-to-b from-gray-100 to-amber-50 p-6 flex flex-col items-center">
  ...
  <section class="bg-amber-100 py-12 text-center">
    <p class="font-great-vibes text-3xl md:text-4xl text-amber-700 mb-2">"Kopi adalah kisah yang diseduh dengan cinta."</p>
