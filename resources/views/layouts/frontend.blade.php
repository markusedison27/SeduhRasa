        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between h-20">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-3 group">
                    ...
                    <div
                        class="w-12 h-12 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <img src="{{ asset('LOGO2.png') }}" alt="Logo SeduhRasa" class="h-full w-auto object-contain">
                    </div>
                    <span
                        class="font-['Great_Vibes'] text-3xl text-[#f5e6d3] group-hover:text-[#c4905c] transition-colors duration-300">
                        SeduhRasa
                    </span>
                </a>
