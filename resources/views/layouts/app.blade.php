      ...
      <div>
        ...
        <nav class="space-y-2">
          <a href="{{ route('dashboard') }}"
             class="block px-4 py-2 rounded-lg font-medium text-stone-700 bg-amber-100 hover:bg-amber-200 transition">
            Dashboard
          </a>
          ...
          <a href="{{ route('admin.menus.index') }}"
             class="block px-4 py-2 rounded-lg text-stone-600 hover:bg-amber-50 hover:text-amber-600 transition">
            Menu
          </a>
